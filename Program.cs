...
switch (input)
{
    ...
    case "3":       
        ...
        if (double.TryParse(multiplyNumber1, out double multNum1) && double.TryParse(multiplyNumber2, out double multNumTwo))
        {
            Console.Write($"{multiplyNumber1} * {multiplyNumber2} = ");
            Console.Write(calculator.Multiply(multNum1, multNumTwo));
        }
        else
        {
